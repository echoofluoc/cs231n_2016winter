...
class ThreeLayerConvNet(object):
  ...
  def loss(self, X, y=None):
    ...
    dx3,grads['W3'],grads['b3'] = affine_backward(dscores, cache_A)
    dx2,grads['W2'],grads['b2'] = affine_relu_backward(dx3, cache_AR)
    dx1,grads['W1'],grads['b1'] = conv_relu_pool_backward(dx2, cache_CRP)
